...
*ENDIF.
  ...
  LOOP AT GT_FCAT INTO GS_FCAT WHERE FIELDNAME = 'FLDATE'.
    GS_FCAT-EDIT_MASK = '____-__-__'.
    MODIFY GT_FCAT FROM GS_FCAT.
  ENDLOOP.
...
MODULE save_data INPUT.
  CASE ok_code.
    WHEN 'SAVE'.
      IF r1 = 'X'.
        PERFORM save_zsc_data.      " 여기서 부터 클릭하면서 수정.  " 수정30
      ELSEIF r2 = 'X'.
        PERFORM save_modify.        " 여기서 부터 클릭하면서 수정.  " 수정31~33
      ENDIF.
  ENDCASE.
ENDMODULE.
*&---------------------------------------------------------------------*
...
* FIELD CATALOG
    PERFORM set_fildcat.    "  여기서 부터 클릭하면서 수정. 26~29
