...
INCLUDE ZABAP_08_TOP.   " 데이터 선언부
INCLUDE ZABAP_08_SEL.   " 검색화면
INCLUDE ZABAP_08_C01.   " 직접 만드는 클래스. 더블 클릭했을 때 이벤트 클래스 메소드
INCLUDE ZABAP_08_F01.   " PERFORM 구문을 다 묶어놨다
INCLUDE ZABAP_08_I01.   " 스크린을 만들었을때 CALL SCREEN 구문이 있을때. PAI/PROCESS AFTER INPUT 여기 구문
INCLUDE ZABAP_08_O01.   " 스크린을 만들었을때 CALL SCREEN 구문이 있을때. PBO/PROCESS BEFORE OUTPUT 여기 구문
