```abap
*&---------------------------------------------------------------------*
*& Report ZABAP_BOOK_SCREEN
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZABAP_BOOK_SCREEN.

INCLUDE ZABAP_BOOK_SCREEN_TOP. " 데이터 선언
INCLUDE ZABAP_BOOK_SCREEN_SEL. " 라디오버튼
INCLUDE ZABAP_BOOK_SCREEN_C01. " 클래스(더블클릭 이벤트)
INCLUDE ZABAP_BOOK_SCREEN_F01. " 실제 기능(Subroutine)
INCLUDE ZABAP_BOOK_SCREEN_O01. " PBO (화면 출력 전)
INCLUDE ZABAP_BOOK_SCREEN_I01. " PAI (화면 입력 후)
