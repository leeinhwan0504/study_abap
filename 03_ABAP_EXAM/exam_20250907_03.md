...
SELECTION-SCREEN BEGIN OF BLOCK part1 WITH FRAME TITLE text-001.
  ...
  SELECTION-SCREEN SKIP.                      " 한 칸 띄우기
  SELECT-OPTIONS s_ccode  FOR scarr-currcode.
  SELECT-OPTIONS s_cname  FOR scarr-carrname.
  SELECT-OPTIONS s_url    FOR scarr-url.      " 한 칸 띄우기
  SELECTION-SCREEN SKIP.
  PARAMETERS NUM TYPE I.
*  PARAMETERS: p_carrid TYPE scarr-carrid OBLIGATORY DEFAULT 'AA'.   " 문자 3자리 필드 하나 선언. 비어있는 상태로 조회하면 안되게한다. DEFAULT 'AA' 가능

selection-SCREEN END OF BLOCK part1.

INITIALIZATION.            " 검색화면이 나오기전에 초기값을 셋팅하는 이벤트
*  s_carrid-sign   = 'I'.
*  s_carrid-option = 'EQ'.
*  s_carrid-low    = 'AA'.
*  s_carrid-high   = ''.
...
*   WHERE carrid = p_carrid. " 항공사 코드(carrid)가 p_carrid 이것과 같은것.
