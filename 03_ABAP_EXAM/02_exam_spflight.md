...
TYPES: BEGIN OF t_sflight,
  mandt       TYPE sflight-mandt,       " 클라이언트
  ...
  planetype   TYPE sflight-planetype,   " 항공기 기종 (CHAR 10 - 737-800)
  seatsmax    TYPE sflight-seatsmax,    " 이코노미석의 최대 좌석 수  (INT4 10 - 385)
  seatsocc    TYPE sflight-seatsocc,    " 이코노미석의 점유된 좌석 수 (INT4 10 - 371)
  paymentsum  TYPE sflight-paymentsum,  " 현재 까지 총 예약 금액 (CURR 17 -  191,334.22)
  seatsmax_b  TYPE sflight-seatsmax_b,  " 비즈니스석의 최대 좌석 수   (INT4 10)
  seatsocc_b  TYPE sflight-seatsocc_b,  " 비즈니스석의 점유된 좌석 수 (INT4 10)
  seatsmax_f  TYPE sflight-seatsmax_f,  " 퍼스트클래스 석의 좌석 수 (INT4 10)
  seatsocc_f  TYPE sflight-seatsocc_f,  " 퍼스트클래스 석의 점유된 좌석 수 (INT4 10)
  END OF t_sflight.
...
FORM build_fieldcatalog.
  ...
  fieldcatalog-seltext_m   = 'Total of current bookings'.
  fieldcatalog-col_pos     = 9.
  APPEND fieldcatalog TO fieldcatalog.
  CLEAR fieldcatalog.

  fieldcatalog-fieldname   = 'EATSMAX_B'.
  fieldcatalog-seltext_m   = 'Maximum capacity in business class'.
  fieldcatalog-col_pos     = 10.
  APPEND fieldcatalog TO fieldcatalog.
  CLEAR fieldcatalog.

  fieldcatalog-fieldname   = 'SEATSOCC_B'.
  fieldcatalog-seltext_m   = 'Occupied seats in business class'.
  fieldcatalog-col_pos     = 11.
  APPEND fieldcatalog TO fieldcatalog.
  CLEAR fieldcatalog.

  fieldcatalog-fieldname   = 'SEATSMAX_F'.
  fieldcatalog-seltext_m   = 'Maximum capacity in first class'.
  fieldcatalog-col_pos     = 12.
  APPEND fieldcatalog TO fieldcatalog.
  CLEAR fieldcatalog.

  fieldcatalog-fieldname   = 'SEATSOCC_F'.
  fieldcatalog-seltext_m   = 'Occupied seats in first class'.
...
**개별 항공편의 스케줄 및 예약 데이터** 
<br><br>
AA 항공사의 0017 항공편에 대한 2017년 12월 19일 데이터입니다. <br>
이 비행의 일반석은 385*석 중 371석이 예약되었고, 비즈니스석은 31*석 중 28석, 1등석은 21*석 중 21석이 예약된 상태입니다. <br>
총 예약 금액은 191,334.22
