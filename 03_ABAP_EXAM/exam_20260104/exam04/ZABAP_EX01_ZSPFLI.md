...
*&
*&---------------------------------------------------------------------*
REPORT ZABAP_EX01_ZSPFLI.


INCLUDE ZABAP_EX_ZSPFLI_TOP.    " 수정 1~7
INCLUDE ZABAP_EX_ZSPFLI_SEL.
INCLUDE ZABAP_EX_ZSPFLI_C01.    " 수정 8~12
INCLUDE ZABAP_EX_ZSPFLI_F01.
INCLUDE ZABAP_EX_ZSPFLI_I01.
INCLUDE ZABAP_EX_ZSPFLI_O01.
...
* 파일 업로드 진행
    ...
    PERFORM GET_DATA.           " 여기서 부터 클릭하면서 수정. 수정 17~18 19~22
ELSEIF r2 = 'X'.
    PERFORM GET_NEEDED_DATA.    " 여기서 부터 클릭하면서 수정.
ELSEIF r3 = 'X'.
    PERFORM DEL_DATA.           " 여기서 부터 클릭하면서 수정. 수정23~24
ENDIF.
